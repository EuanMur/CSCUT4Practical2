    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String line = scanner.nextLine();
             ...
             bothNames[0] = bothNames[0].toUpperCase();
             bothNames[1] = bothNames[1].toUpperCase();
             bothNames[2] = bothNames[2].toUpperCase();
             String fullName = bothNames[0] + " " + bothNames[1] + " " + bothNames[2];
